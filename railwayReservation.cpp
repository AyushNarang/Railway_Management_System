...
class Detail
{
	public:
		...
		void getDetail()
		{
			...
			std::cout << "Train no: ";
			std::cin >> tno;
			//std::getchar(); Temporary solution to add this line stops infinite loop but still does not accept input
            //ERROR: Goes into an infinite loop without taking next input
			std::cout << "Train Name: ";
			std::cin >> tname;
